	...
	[
		{
			...
			setUp: function(){
				...
				for(var i = 0 ; i < partLocaleList.length; i ++){
					dojo.requireLocalization("dojo.cldr","currency",partLocaleList[i], "ROOT,de,en,en-au,en-ca,en-us,es,fr,it,ja,ko,pt,zh");
					dojo.requireLocalization("dojo.cldr","number",partLocaleList[i], "de,de-de,en,en-ca,en-us,es,es-es,fr,it,ja-jp,ko-kr,ROOT,pt,zh-cn,zh-tw");
				}
			},
			runTest: function(t){
