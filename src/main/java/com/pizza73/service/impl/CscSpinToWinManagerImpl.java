...
import com.pizza73.service.CscSpinToWinManager;
import com.pizza73.service.LookupManager;
import com.pizza73.service.MailEngine;
import com.pizza73.service.OrderManager;

@Service("cscSpinToWinManager")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public class CscSpinToWinManagerImpl implements CscSpinToWinManager
{
    @SuppressWarnings("unused")
    private static final Logger log = Logger.getLogger(CscSpinToWinManagerImpl.class);
    ...
    private String getPrizeMessage(Integer prizeId, String couponeCode)
    {
        ...
        if (prizeId > 6)
        {
            message = message + "  Your reference number is " + couponeCode
                + ".  The customer service center will contact you in the coming few days.";
        }
        else
        {
