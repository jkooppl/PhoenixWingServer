 ...
 *         &lt;element name="clearsublist" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = { "mailinglistid", "descriptor", "csvcontents", "sublistid", "clearsublist" })
@XmlRootElement(name = "SubmitCsvFileWithSublist")
public class SubmitCsvFileWithSublist
{
    ...
    protected boolean clearsublist;
    ...
    /**
     * Gets the value of the clearsublist property.
     * 
     */
    public boolean isClearsublist()
    {
        return this.clearsublist;
    }

    /**
     * Sets the value of the clearsublist property.
     * 
     */
    public void setClearsublist(boolean value)
    {
        this.clearsublist = value;
    }
