...
@XmlType(name = "", propOrder = { "mailinglistid", "subscriber", "checkrequired", "sublistids" })
@XmlRootElement(name = "SignupNewSubscriberToSublist")
public class SignupNewSubscriberToSublist
{
