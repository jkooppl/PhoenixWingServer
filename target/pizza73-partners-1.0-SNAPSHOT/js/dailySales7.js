...
var globalObj={errors:new Array(),
               ...
               numberofFrontCounterMachines:0,
               numberofWirelessMachines:0,
               cleanUp:function(){
	            ...
	            populateValidationNodes:function(){
	             ...
	             this.numberofFrontCounterMachines=Number(dojo.byId("numberofFrontCounterMachines").value);
	       		 this.numberofWirelessMachines=Number(dojo.byId("numberofWirelessMachines").value);
	             this.validationNodeList=new Array(new ValidationNode("computerSales","COMPUTER SALES"),
	               						...
	               						new ValidationNode("giftcardReload","Pizza Card Reload"),
	               						...
	               						new ValidationNode("cateringCredit", "CATERING CREDIT"),
	               						...
	               						this.validationNodeList[this.validationNodeList.length]=new ValidationNode("BatchRecords_"+(i-1)+"_giftcard","PIZZA CARD IN FRONT-COUNTER  MACHINE #"+i);
	              						...
	              						for(i=this.numberofFrontCounterMachines+1;i<=(this.numberofFrontCounterMachines+this.numberofWirelessMachines);i++){
	               						...
	               						this.validationNodeList[this.validationNodeList.length]=new ValidationNode("BatchRecords_"+(i-1)+"_giftcard","PIZZA CARD IN WIRELESS MACHINE #"+(i-this.numberofFrontCounterMachines));
...
//---code for validation---//
    ...
    function validateNode(validationNode){
       ...
       return ;
       if((validationNode.nodeId.indexOf("cateringCredit") != -1 ) &&dwr.util.getValue("version")  < 3)
           return ;       
    ...
    validateNode(new ValidationNode("labourCost", "EMPLOYEES LABOUR COST"));
    displayErrorAndWarning();
    }
...
//---code for update and format---//
    ...
    function updateFoodAndBeverageSales(){
       var val=formGetValue("netSalesTotal_cell_sum_2");
       val=RoundToTwoDigit(val);
    ...
    function autoUpdate(){
        ...
        updatewirelessDriverGiftcardTotal();
        updatewirelessDriverTotal();
        updateMachineTotal();
        //Grand total Table
        updateCashTotal();
        if(dwr.util.getValue("version") >2){
        updateCateringCredit();
        }
    ...
    function updateCateringCredit(){
        var val=formGetValue("cateringCredit");
        val=RoundToTwoDigit(val);
        dwr.util.setValue("cateringCredit_cell_2",val);     
     }    
    ...
    function updateGiftcardTotal(){
       var val=formGetValue("inStoreGiftcardTotal_cell_1")+formGetValue("wirelessDriverGiftcardTotal_cell_1");
       val=RoundToTwoDigit(val);
       dwr.util.setValue("giftcardTotal_cell_1",val);
       dwr.util.setValue("giftcardTotal_cell_2",val);      
    }
    ...
    function updateGrandTotal(){
       ...
       if(dwr.util.getValue("version") >2){
    	   val = val + formGetValue("cateringCredit");
       }
       val=RoundToTwoDigit(val);
    ...
    function updatewirelessDriverTotal(){
       var val=formGetValue("wirelessDriverDebitTotal_cell_1")+formGetValue("wirelessDriverVisaTotal_cell_1")+formGetValue("wirelessDriverMastercardTotal_cell_1")+formGetValue("wirelessDriverAmexTotal_cell_1")+formGetValue("wirelessDriverGiftcardTotal_cell_1");
       val=RoundToTwoDigit(val);
    ...
    function updateInStoreTotal(){
       var val=formGetValue("inStoreVisaTotal_cell_1")+formGetValue("inStoreMastercardTotal_cell_1")+formGetValue("inStoreAmexTotal_cell_1")+formGetValue("inStoreDebitTotal_cell_1")+formGetValue("inStoreGiftcardTotal_cell_1");
       val=RoundToTwoDigit(val);
    ...
    function updateTotalReceipts(){
     var val=formGetValue("netToPizza73_cell_1")+formGetValue("gst") +formGetValue("giftCertificateSold")+formGetValue("giftcardReload");
     val=RoundToTwoDigit(val);
    ...
    function formatBatchRecords(){
      ...
      BatchRecordsValueReplace("giftcard");
    ...
    function updateBatchRecordTotal(index){
	    ...
	    index--;
	    if(AllEmpty != true){
       val=formGetValue("BatchRecords_"+index+"_visa")+formGetValue("BatchRecords_"+index+"_mastercard")+formGetValue("BatchRecords_"+index+"_amex")+formGetValue("BatchRecords_"+index+"_debit")+formGetValue("BatchRecords_"+index+"_giftcard");
       val=RoundToTwoDigit(val);
       }
    ...
    function updateInStoreDebitTotal(){
     ...
     function updateInStoreGiftcardTotal(){
       var val=0;
       var num=globalObj.numberofFrontCounterMachines;
       for(i=0;i<num;i++)
         val=val+formGetValue("BatchRecords_"+i+"_giftcard");
       val=RoundToTwoDigit(val);
       dwr.util.setValue("inStoreGiftcardTotal_cell_1",val);
       dwr.util.setValue("inStoreGiftcardTotal_cell_2",val); 
    }       
    
    function updatewirelessDriverAmexTotal(){
       var val=0;
       for(i=globalObj.numberofFrontCounterMachines;i<(globalObj.numberofFrontCounterMachines+globalObj.numberofWirelessMachines);i++)
       val=val+formGetValue("BatchRecords_"+i+"_amex");
       val=RoundToTwoDigit(val);
    ...
    function updatewirelessDriverGiftcardTotal(){
       var val=0;
       for(i=globalObj.numberofFrontCounterMachines;i<(globalObj.numberofFrontCounterMachines+globalObj.numberofWirelessMachines);i++)
         val=val+formGetValue("BatchRecords_"+i+"_giftcard");
       val=RoundToTwoDigit(val);
       dwr.util.setValue("wirelessDriverGiftcardTotal_cell_1",val);
       dwr.util.setValue("wirelessDriverGiftcardTotal_cell_2",val); 
    }
	...
	function BatchRecordsValueReplace(field){
       ...
       var val='';
       var i=0;
       var totalNum=globalObj.numberofFrontCounterMachines+globalObj.numberofWirelessMachines;
       for(i=0;i<globalObj.numberofFrontCounterMachines;i++){
       ...
       var val=null;
       var i=0;
       for(i=globalObj.numberofFrontCounterMachines;i<totalNum;i++){
         val=dojo.byId("BatchRecords_"+i+"_"+field).value;
         if(!isEmpty(val))
           temp.push(val);
       }
       for(i=globalObj.numberofFrontCounterMachines;i<totalNum;i++){
         if((i-globalObj.numberofFrontCounterMachines)<temp.length)
         dojo.byId("BatchRecords_"+i+"_"+field).value=temp[i-globalObj.numberofFrontCounterMachines];
         else
         dojo.byId("BatchRecords_"+i+"_"+field).value='';
       }          
    }
    ...
    function updateBatchRecordTotals(){
      var i=1;
      var num=globalObj.numberofFrontCounterMachines+globalObj.numberofWirelessMachines;
      for(i=1;i<=num;i++)
